...
use Yii\Asset\Js\FilePondEncodePluginProd;
use Yii\Asset\Js\FilePondImageExifOrientationPluginProd;
use Yii\Asset\Js\FilePondValidateSizePluginProd;
use Yii\Asset\Js\FilePondValidateTypePluginProd;
